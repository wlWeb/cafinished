        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown <?php echo ($page == "home" ? "active" : "")?>">
              <a href="index.php" class="dropdown-toggle animated fadeIn animation-delay-4" data-hover="dropdown" data-name="home">Home                 
                </a>
            </li>
            <li class="dropdown <?php echo ($page == "location" ? "active" : "")?>">
              <a href="locations.php" class="dropdown-toggle animated fadeIn animation-delay-5" data-hover="dropdown" data-name="page">Locations                  
                </a>
            </li>
            ...
            <li class="dropdown <?php echo ($page == "about" ? "active" : "")?>">
              <a href="aboutus.php" class="dropdown-toggle animated fadeIn animation-delay-6" data-hover="dropdown" role="button" aria-haspopup="true"
                aria-expanded="false" data-name="component">About Us                 
                </a>
            </li>
            <li class="dropdown <?php echo ($page == "faq" ? "active" : "")?>">
              <a href="faq.php" class="dropdown-toggle animated fadeIn animation-delay-7" data-hover="dropdown" role="button" aria-haspopup="true"
